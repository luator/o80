...
PYBIND11_MODULE(o80, m)
{
    ...
    pybind11::class_<o80::Duration>(m, "Duration")
        .def("seconds", o80::Duration::seconds)
        .def("milliseconds", o80::Duration::milliseconds)
        .def("microseconds", o80::Duration::microseconds)
        .def("nanoseconds", o80::Duration::nanoseconds);
